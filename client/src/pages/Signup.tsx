  ...
  return (
    <div className="auth-root">
      ...
      <div className="auth-card">
        ...
        <h1 className="auth-title auth-display">Join the Market</h1>
        <p className="auth-sub">Create a premium account for your business.</p>
        ...
        <form onSubmit={handleSubmit}>
          <div className="auth-form-group">
            ...
            <div className="auth-input-wrap">
              ...
              <input 
                ...
                placeholder="e.g. Auntie Ama Supermarket" 
                required
                value={formData.name}
          ...
          <button className="auth-btn" type="submit" disabled={isSubmitting}>
            {isSubmitting ? <Loader2 className="animate-spin" /> : <>Create Account <ArrowRight size={20} /></>}
          </button>
        </form>
